...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    public boolean init() throws IOException { // CraftBukkit - decompile error
        ...
        */
        ...
        thread.start();
        DedicatedServer.LOGGER.info("启动 Minecraft 服务器版本 1.12.2");
        if (Runtime.getRuntime().maxMemory() / 1024L / 1024L < 512L) {
            DedicatedServer.LOGGER.warn("To start the server with more ram, launch it as \"java -Xmx1024M -Xms1024M -jar minecraft_server.jar\"");
        }

        DedicatedServer.LOGGER.info("正在加载配置");
        ...
        if (!this.r.a() && !eulaAgreed) { // Spigot
            ...
            DedicatedServer.LOGGER.info("默认游戏模式: {}", this.t);
            ...
            DedicatedServer.LOGGER.info("服务器启动在端口 {}:{}", this.getServerIp().isEmpty() ? "*" : this.getServerIp(), Integer.valueOf(this.P()));
        ...
        if (!org.spigotmc.SpigotConfig.lateBind) {
            ...
            if (!NameReferencingFileConverter.a(this.propertyManager)) {
                ...
                DedicatedServer.LOGGER.info("完成 ({})! 帮助请输入 \"help\" 或 \"?\"", s3);
